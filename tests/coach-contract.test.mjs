...
const eventsUrl = moduleUrl(await read('../lib/event-stream.ts'));
const coachUrl = moduleUrl((await read('../lib/coach.ts')).replace("'./event-stream'", JSON.stringify(eventsUrl)));
