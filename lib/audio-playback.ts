...
export async function playAudioSegments<T>({ segments, prepare, audio, signal, speed = 1 }: {
  segments: T[]; prepare: (segment: T) => Promise<Blob>; audio: HTMLAudioElement; signal: AbortSignal; speed?: number;
}) {
